...
public class InBody {
    ...
    public InBody(Long id, String inBody_user_id, String inBody_weight, String inBody_rmr, String inBody_bfp, String inBody_smm, String inBody_date, Member member) {
        this.id = id;
